# Generated by Django 5.2.8 on 2026-03-04 08:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "html_content",
                    models.TextField(blank=True, help_text="HTML email body"),
                ),
                (
                    "text_content",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.TextField(
                        blank=True, help_text="Additional details about the action"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="organizations_sms_configurations",
                        to="authentication.organization",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="organizations_sms_templates",
                        to="authentication.organization",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            model_name="providerauditlog",
            index=models.Index(
                fields=["organization", "created_at"],
                name="campaigns_p_organiz_cd6932_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="providerauditlog",
            index=models.Index(
                fields=["provider", "created_at"], name="campaigns_p_provide_0c00f9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="providerauditlog",
            index=models.Index(
                fields=["user", "created_at"], name="campaigns_p_user_id_215c09_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="providerauditlog",
            index=models.Index(
                fields=["action", "created_at"], name="campaigns_p_action_09e151_idx"
            ),
        ),
        migrations.AddIndex(
