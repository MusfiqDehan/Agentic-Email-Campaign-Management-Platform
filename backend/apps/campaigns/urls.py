...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/schedule/", CampaignScheduleView.as_view(), name="campaign-schedule"
    ),
    ...
    path(
        "<uuid:pk>/refresh-stats/",
        CampaignRefreshStatsView.as_view(),
        name="campaign-refresh-stats",
    ),
    # Contacts
    ...
    path(
        "contacts/<uuid:pk>/toggle-status/",
        ContactToggleStatusView.as_view(),
        name="contact-toggle-status",
    ),
    # Contact Lists
    path(
        "contact-lists/",
        ContactListListCreateView.as_view(),
        name="contact-list-list-create",
    ),
    path(
        "contact-lists/<uuid:pk>/",
        ContactListDetailView.as_view(),
        name="contact-list-detail",
    ),
    path(
        "contact-lists/<uuid:pk>/refresh-stats/",
        ContactListRefreshStatsView.as_view(),
        name="contact-list-refresh-stats",
    ),
    # ========================================================================
    ...
    path(
        "config/",
        OrganizationEmailConfigurationListCreateView.as_view(),
        name="org-email-config-list",
    ),
    path(
        "config/<uuid:pk>/",
        OrganizationEmailConfigurationDetailView.as_view(),
        name="org-email-config-detail",
    ),
    path(
        "config/<uuid:pk>/reset-usage/",
        OrganizationEmailConfigurationResetUsageView.as_view(),
        name="org-email-config-reset-usage",
    ),
    path(
        "config/<uuid:pk>/verify-domain/",
        OrganizationEmailConfigurationVerifyDomainView.as_view(),
        name="org-email-config-verify-domain",
    ),
    path(
        "config/usage-stats/",
        OrganizationEmailConfigurationUsageStatsView.as_view(),
        name="org-email-config-usage-stats",
    ),
    # Organization Email Providers (links org to shared/platform providers)
    path(
        "providers/",
        OrganizationEmailProviderListCreateView.as_view(),
        name="org-email-provider-list-create",
    ),
    path(
        "providers/<uuid:pk>/",
        OrganizationEmailProviderDetailView.as_view(),
        name="org-email-provider-detail",
    ),
    # Organization Own Email Providers (org-owned providers created by org admins)
    path(
        "org/providers/",
        OrganizationOwnEmailProviderListCreateView.as_view(),
        name="org-own-provider-list-create",
    ),
    path(
        "org/providers/<uuid:pk>/",
        OrganizationOwnEmailProviderDetailView.as_view(),
        name="org-own-provider-detail",
    ),
    path(
        "org/providers/<uuid:pk>/health-check/",
        OrganizationOwnEmailProviderHealthCheckView.as_view(),
        name="org-own-provider-health-check",
    ),
    path(
        "org/providers/<uuid:pk>/test-send/",
        OrganizationOwnEmailProviderTestSendView.as_view(),
        name="org-own-provider-test-send",
    ),
    # Shared Email Providers (read-only for regular users)
    path(
        "shared-providers/",
        EmailProviderListCreateView.as_view(),
        name="shared-email-provider-list",
    ),
    path(
        "shared-providers/<uuid:pk>/",
        EmailProviderDetailView.as_view(),
        name="shared-email-provider-detail",
    ),
    path(
        "shared-providers/<uuid:pk>/health-check/",
        EmailProviderHealthCheckView.as_view(),
        name="shared-email-provider-health-check",
    ),
    # ========================================================================
    ...
    path(
        "rules/",
        AutomationRuleListCreateView.as_view(),
        name="automation-rule-list-create",
    ),
    path(
        "rules/<uuid:pk>/",
    ...
    path(
        "trigger/email/<uuid:rule_id>/",
        EnhancedTriggerEmailView.as_view(),
        name="trigger-email-by-rule",
    ),
    # Email Queue
    ...
    path(
        "logs/<uuid:pk>/",
        EmailDeliveryLogDetailView.as_view(),
        name="email-delivery-log-detail",
    ),
    path(
        "logs/<uuid:pk>/resend/",
        EmailDeliveryLogResendView.as_view(),
        name="email-delivery-log-resend",
    ),
    path(
        "logs/<uuid:pk>/forward/",
        EmailDeliveryLogForwardView.as_view(),
        name="email-delivery-log-forward",
    ),
    path(
        "logs/analytics/",
        EmailDeliveryLogAnalyticsView.as_view(),
        name="email-delivery-log-analytics",
    ),
    # Email Validation
    path(
        "validations/", EmailValidationListView.as_view(), name="email-validation-list"
    ),
    path(
        "validations/<uuid:pk>/",
        EmailValidationDetailView.as_view(),
        name="email-validation-detail",
    ),
    # Email Actions
    path("actions/", EmailActionListView.as_view(), name="email-action-list"),
    path(
        "actions/<uuid:pk>/",
        EmailActionDetailView.as_view(),
        name="email-action-detail",
    ),
    # ========================================================================
    ...
    path(
        "sms/configs/",
        SMSConfigurationListCreateView.as_view(),
        name="sms-config-list-create",
    ),
    path(
        "sms/configs/<uuid:pk>/",
        SMSConfigurationDetailView.as_view(),
    ...
    path(
        ...
        name="sms-template-list-create",
    ),
    path(
        "sms/templates/<uuid:pk>/",
    ...
    path(
        "trigger/sms/<uuid:rule_id>/",
        TriggerSMSView.as_view(),
        name="trigger-sms-by-rule",
    ),
    path("trigger/whatsapp/", TriggerWhatsAppView.as_view(), name="trigger-whatsapp"),
    path(
        "trigger/whatsapp/<uuid:rule_id>/",
        TriggerWhatsAppView.as_view(),
        name="trigger-whatsapp-by-rule",
    ),
    # ========================================================================
    ...
    path(
        "admin/providers/",
        AdminEmailProviderListCreateView.as_view(),
        name="admin-provider-list-create",
    ),
    path(
        "admin/providers/<uuid:pk>/",
        AdminEmailProviderDetailView.as_view(),
        name="admin-provider-detail",
    ),
    path(
        "admin/providers/<uuid:pk>/set-default/",
        AdminEmailProviderSetDefaultView.as_view(),
        name="admin-provider-set-default",
    ),
    path(
        "admin/providers/<uuid:pk>/health-check/",
        AdminEmailProviderHealthCheckView.as_view(),
        name="admin-provider-health-check",
    ),
    path(
        "admin/providers/<uuid:pk>/test-send/",
        AdminEmailProviderTestSendView.as_view(),
        name="admin-provider-test-send",
    ),
    # Admin Organization Configs
    path(
        "admin/organizations/",
        AdminOrganizationConfigListView.as_view(),
        name="admin-org-config-list",
    ),
    path(
        "admin/organizations/<uuid:pk>/",
        AdminOrganizationConfigDetailView.as_view(),
        name="admin-org-config-detail",
    ),
    path(
        "admin/organizations/<uuid:pk>/activate/",
        AdminOrganizationActivateView.as_view(),
        name="admin-org-activate",
    ),
    path(
        "admin/organizations/<uuid:pk>/deactivate/",
        AdminOrganizationDeactivateView.as_view(),
        name="admin-org-deactivate",
    ),
    path(
        "admin/organizations/<uuid:pk>/suspend/",
        AdminOrganizationSuspendView.as_view(),
        name="admin-org-suspend",
    ),
    path(
        "admin/organizations/<uuid:pk>/unsuspend/",
        AdminOrganizationUnsuspendView.as_view(),
        name="admin-org-unsuspend",
    ),
    path(
        "admin/organizations/<uuid:pk>/upgrade-plan/",
        AdminOrganizationUpgradePlanView.as_view(),
        name="admin-org-upgrade-plan",
    ),
    ...
    path(
        "public/subscribe/",
        PublicContactSubscribeView.as_view(),
    ...
    path(
        "dispatches/", EmailDispatchReportView.as_view(), name="email-dispatch-report"
    ),
    ...
    path(
        "variables/validate/", VariableValidateView.as_view(), name="variable-validate"
    ),
    path("variables/preview/", VariablePreviewView.as_view(), name="variable-preview"),
    path(
        "variables/schema/", CustomFieldSchemaView.as_view(), name="custom-field-schema"
    ),
    # ========================================================================
    ...
    path(
        ...
        GenerateEmailContentAIView.as_view(),
        name="generate-email-content-ai",
    ),
    ...
    path(
        "templates/<uuid:pk>/use/", EmailTemplateUseView.as_view(), name="template-use"
    ),
    path(
    ...
    path(
        "templates/bulk-use/",
        EmailTemplateBulkUseView.as_view(),
        name="template-bulk-use",
    ),
    # Template versioning
    path(
        "templates/<uuid:pk>/versions/",
        EmailTemplateVersionHistoryView.as_view(),
        name="template-versions",
    ),
    path(
        "templates/<uuid:pk>/create-version/",
        EmailTemplateCreateVersionView.as_view(),
        name="template-create-version",
    ),
    # Approval workflow
    path(
        "templates/<uuid:pk>/submit-approval/",
        EmailTemplateSubmitForApprovalView.as_view(),
        name="template-submit-approval",
    ),
    path(
        "approvals/<uuid:pk>/review/",
        TemplateApprovalReviewView.as_view(),
        name="template-approval-review",
    ),
    # Preview and testing
    path(
        "templates/preview-test/",
        TemplatePreviewTestView.as_view(),
        name="template-preview-test",
    ),
    # Template updates
    path(
        "templates/<uuid:pk>/update-from-global/",
        EmailTemplateUpdateFromGlobalView.as_view(),
        name="template-update-from-global",
    ),
    # ========================================================================
    ...
    path(
        "admin/templates/",
        AdminGlobalTemplateListCreateView.as_view(),
        name="admin-templates-list",
    ),
    path(
        "admin/templates/<uuid:pk>/",
        AdminGlobalTemplateDetailView.as_view(),
        name="admin-template-detail",
    ),
    # Template analytics
    path(
        "admin/templates/<uuid:pk>/analytics/",
        AdminTemplateAnalyticsView.as_view(),
        name="admin-template-analytics",
    ),
    path(
        "admin/templates/analytics/summary/",
        AdminTemplateAnalyticsSummaryView.as_view(),
        name="admin-template-analytics-summary",
    ),
    # Approval management
    path(
        "admin/approvals/pending/",
        AdminPendingApprovalsView.as_view(),
    ...
    path(
        "organization/template-usage/",
        OrganizationTemplateUsageView.as_view(),
        name="organization-template-usage",
    ),
    # Template notifications
    path(
        "organization/template-notifications/",
        OrganizationTemplateNotificationsView.as_view(),
        name="organization-template-notifications",
    ),
    path(
        "organization/template-notifications/<uuid:pk>/mark-read/",
        OrganizationTemplateNotificationMarkReadView.as_view(),
        name="organization-notification-mark-read",
    ),
    # Update status and stats
    path(
        "organization/template-updates/",
        OrganizationTemplateUpdateStatusView.as_view(),
        name="organization-template-updates",
    ),
    path(
        "organization/team-template-stats/",
        OrganizationTeamTemplateStatsView.as_view(),
        name="organization-team-stats",
    ),
    # ========================================================================
    ...
    path(
        "push/subscribe/",
        PushSubscriptionViewSet.as_view({"post": "create"}),
        name="push-subscribe",
    ),
    path(
        "push/subscriptions/",
        PushSubscriptionViewSet.as_view({"get": "list"}),
        name="push-subscriptions",
    ),
    path(
        "push/unsubscribe/",
        PushSubscriptionViewSet.as_view({"delete": "destroy"}),
        name="push-unsubscribe",
    ),
    path(
        "push/test/",
        PushSubscriptionViewSet.as_view({"post": "test"}),
        name="push-test",
    ),
]
