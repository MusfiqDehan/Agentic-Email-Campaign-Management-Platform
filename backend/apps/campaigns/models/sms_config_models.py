...
class SMSConfigurationModel(BaseModel):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='organizations_sms_configurations')
...
class SMSTemplate(BaseModel):
    ...
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='organizations_sms_templates')
